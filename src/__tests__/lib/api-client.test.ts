...
describe("normalizeUtc", () => {
  ...
  it("passes through a datetime with positive offset unchanged", () => {
    expect(normalizeUtc("2026-05-12T21:30:00+02:00")).toBe(
      "2026-05-12T21:30:00+02:00"
    );
  });

  it("passes through a datetime with negative offset unchanged", () => {
    expect(normalizeUtc("2026-05-12T14:30:00-05:00")).toBe(
      "2026-05-12T14:30:00-05:00"
    );
  });
  ...
  it("passes through a datetime with fractional seconds and Z", () => {
    expect(normalizeUtc("2026-05-12T19:30:00.123Z")).toBe(
      "2026-05-12T19:30:00.123Z"
    );
  });
